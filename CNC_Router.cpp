...
CNC_Router::CNC_Router(): mx(), my(), old_p(), end_p(), actual_p(), spmmx(0.0), spmmy(0.0), v_max_x(0.0), v_max_y(0.0), pos_type(false), pin_ls_x_down(-1), pin_ls_y_down(-1), pin_ls_x_up(-1), pin_ls_y_up(-1) {}
CNC_Router::CNC_Router(float spx, float spy, float vmx, float vmy) : mx(), my(), old_p(), end_p(), actual_p(), spmmx(spx), spmmy(spy), v_max_x(vmx), v_max_y(vmy), pos_type(false), pin_ls_x_down(-1), pin_ls_y_down(-1), pin_ls_x_up(-1), pin_ls_y_up(-1) {}
...
void CNC_Router::resetPos() { old_p = end_p = actual_p = PositionXY(0.0, 0.0); }
