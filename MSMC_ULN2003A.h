...
static int full_step_seq[4][4] = { { HIGH, LOW, LOW, HIGH }, { HIGH, LOW, HIGH,
		LOW }, { LOW, HIGH, HIGH, LOW }, { LOW, HIGH, LOW, HIGH } }; /*!< \brief Define the full step sequence to drive an unipolar motor.*/

static int half_step_seq[8][4] = { { HIGH, LOW, LOW, HIGH }, { HIGH, LOW, LOW,
		LOW }, { HIGH, LOW, HIGH, LOW }, { LOW, LOW, HIGH, LOW }, { LOW, HIGH,
		HIGH, LOW }, { LOW, HIGH, LOW, LOW }, { LOW, HIGH, LOW, HIGH }, { LOW,
		LOW, LOW, HIGH } }; /*!< \brief Define the half step sequence to drive an unipolar motor. */
